    ...
    <modal name="new-project" classes="p-10 bg-card rounded-lg" height="auto">
        ...
        <form @submit.prevent="submit">
                ...
                <div class="flex-1 ml-4">
                    <div class="mb-4">
                        ...
                        <input type="text" class="border border-muted-light mb-2 p-2 text-xs block w-full rounded"
                            placeholder="Task 1" :key="index" v-for="(task, index) in form.tasks" v-model="task.body" />
                    </div>
            ...
            <footer class="flex justify-end">
                <button type="button" class="button is-outlined mr-4" @click="$modal.hide('new-project')">
                    Cancel
                </button>
