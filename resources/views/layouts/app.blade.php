                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="291" height="45" viewBox="0 0 291 45"
                                ...
                                <g fill="none" fill-rule="evenodd">
                                    <g class="fill-current">
                                        ...
                                        <text font-family="Helevetica" font-size="12" transform="translate(51 14)">
                        ...
                        <div class="flex items-center ml-auto">
                            ...
                            <dropdown align="right" width="200px">
                                <template v-slot:trigger>
                                    <button class="flex item-center text-default no-underline text-sm focus:outline-none">
                                        <img width="35" src="{{ gravatar_url(auth()->user()->email) }}"
                                        class="rounded-full w-10 h-10">
                                        <span class="text-lg ml-4">{{ auth()->user()->name }}</span>
                                    </button>
                                </template>
